        ...
        const data: ProjectModel[] = [
            {
                ...
                imgLeft:'/proyects/p4.1.svg',
                imgCenter: '/proyects/p4.svg',
                imgRight:'/proyects/p4.2.svg',
                reverse: false
            },
            {
                title: 'RickCloud',
                ...
                imgLeft:'/proyects/p2.1.svg',
                imgCenter: '/proyects/p2.svg',
                imgRight:'/proyects/p2.2.svg',
                reverse: true
            },
            {
                title: 'AuthTest',
                ...
                imgLeft:'/proyects/p6.1.svg',
                imgCenter: '/proyects/p6.svg',
                imgRight:'/proyects/p6.2.svg',
                reverse: false
            },
            {
                title: 'ImcUI',
                ...
                imgLeft:'/proyects/p5.1.svg',
                imgCenter: '/proyects/p5.svg',
                imgRight:'/proyects/p5.2.svg',
                reverse: true
            },
        ]
        return data
